...
function main(){
    let a = parseInt(document.getElementById('input_number').value);
    let array = [];
    for(let i = 0; i < a ; i++){
            x = Math.floor(Math.random()*30);
            array.push(x);           
    }
    document.getElementById("array_nums").innerHTML = array;
    ...
    document.getElementById("max_num").innerHTML = `Giá trị lớn nhất trong dãy là ${array_index_one}`;
    // tìm số nhỏ nhất
    ...
    document.getElementById("min_num").innerHTML = `Giá trị nhỏ nhất trong dãy là ${array_index_one}`;
    let array_empty = [];
    ...
    if (array_empty.length > 0){
        document.getElementById('prime_num').innerHTML = `${array_empty} là số nguyên tố trong dãy`;
    }else{
        document.getElementById('prime_num').innerHTML = "Không có số nguyên tố trong dãy";
    }
    let evan_number = [];
    let odd_number = []
    ...
    document.getElementById('even_num').innerHTML = `${evan_number} là số chẵn trong dãy`;
    document.getElementById('odd_num').innerHTML = `${odd_number} là số lẻ trong dãy`;
    ...
    if (array_one.length > 0){
        document.getElementById('perfect_num').innerHTML = `${array_one} là số hoàn hảo trong dãy`;
    }else{
        document.getElementById('perfect_num').innerHTML = "Không có số hoàn hảo trong dãy";
    }
    if (array_square_number.length > 0){
        document.getElementById('square_num').innerHTML = `${array_square_number} là số chính phương trong dãy`;
    }else{
        document.getElementById('square_num').innerHTML = "Không có số chính phương trong dãy";
    }
